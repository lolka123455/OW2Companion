...
import com.playerDetailsInfoScreen.ow2companion.databinding.FragmentQuickplayPlayerDetailsInfoBinding
...
class QuickPlayPlayerDetailsInfoFragment : Fragment() {
    ...
    private fun setInitialDataQuickPlay() {
        arguments?.getString("player")?.let { player ->
            viewModel.getViewPagerQuickPlayDetailsInfo(player)
        } ?: run {
